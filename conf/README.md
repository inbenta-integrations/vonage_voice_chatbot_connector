...
Nexmo provides to their clients a **sandbox environment** to make tests. For this reason, the development envoirment has been changed by the **sandbox environment** and its credentials should be provided by the sandbox config file.
